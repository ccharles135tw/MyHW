...
SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM Products WHERE (ProductID = @ProductID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT ProductID, ProductName, SupplierID, p.CategoryID, QuantityPerUnit, UnitPri" +
                "ce, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued\r\nFROM dbo.Products p\r" +
                "\njoin categories c on c.categoryid=p.categoryid\r\nwhere c.categoryname = @name";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.NVarChar, 15, global::System.Data.ParameterDirection.Input, 0, 0, "CategoryName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products\r\nwher" +
                "e productname like  \'%\'+@input+\'%\'";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@input", global::System.Data.SqlDbType.NVarChar, 40, global::System.Data.ParameterDirection.Input, 0, 0, "ProductName", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[3].CommandText = "SELECT ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitPrice" +
                ", UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued FROM dbo.Products\r\nwher" +
                "e UnitPrice > @intput1 and UnitPrice < @intput2";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@intput1", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@intput2", global::System.Data.SqlDbType.Money, 8, global::System.Data.ParameterDirection.Input, 0, 0, "UnitPrice", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillBy(NWDataSet.ProductsDataTable dataTable, string name) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBySearch(NWDataSet.ProductsDataTable dataTable, string input) {
        ...
        public virtual NWDataSet.ProductsDataTable GetDataBySearch(string input) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((input == null)) {
                throw new global::System.ArgumentNullException("input");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByUnitPrice(NWDataSet.ProductsDataTable dataTable, global::System.Nullable<decimal> intput1, global::System.Nullable<decimal> intput2) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((intput1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(intput1.Value));
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            if ((intput2.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[1].Value = ((decimal)(intput2.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual NWDataSet.ProductsDataTable GetDataByUnitPrice(global::System.Nullable<decimal> intput1, global::System.Nullable<decimal> intput2) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            if ((intput1.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((decimal)(intput1.Value));
            }
